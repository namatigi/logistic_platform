...
class TenderAdmin(admin.ModelAdmin):
    list_display = ('customer', 'reference', 'route_loading', 'route_delivery', 'cargo_date', 'trans_reference', 'status', 'response_code')
    list_filter = ('status', 'cargo_type', 'truck_type')
    search_fields = ('reference', 'customer', 'route_loading', 'route_delivery', 'trans_reference')
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_name', 'order_id', 'customer', 'state', 'currency', 'amount_total', 'trans_reference', 'date_order')
    list_filter = ('state', 'currency')
    search_fields = ('order_name', 'order_id', 'customer', 'trans_reference')
