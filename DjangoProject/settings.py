...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tenders.context_processors.map_config',
            ],
        },
    },
]
...
# Google OAuth2 (Sign in with Google). Configure in the Google Cloud console
# and expose the credentials as Railway environment variables.
